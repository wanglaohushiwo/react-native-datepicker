...
class DatePicker extends React.Component{
  ...
  getDateData() {
    ...
    for (let i = minDay; i <= maxDay; i++) {
      const label = formatDay ? formatDay(i, date) : i + I18n.t("day") + '';
      days.push({
        value: i + '',
        label,
      });
  ...
  getTimeData(date: any) {
    ...
    if ((minHour === 0 && maxHour === 0) || (minHour !== 0 && maxHour !== 0)) {
      ...
      hours.push({
        value: '0',
        label: I18n.t("hour") ? '12' + I18n.t("hour") : '12',
      });
    }
    ...
    for (let i = minHour; i <= maxHour; i++) {
      hours.push({
        value: i + '',
        label: I18n.t("hour") ? i + I18n.t("hour") + '' : pad(i),
      });
    }
    ...
    for (let i = minMinute; i <= maxMinute; i += minuteStep) {
      minutes.push({
        value: i + '',
        label: I18n.t("minute") ? i + I18n.t("minute") + '' : pad(i),
      });
      if (selMinute > i && selMinute < i + minuteStep) {
        minutes.push({
          value: selMinute + '',
          label: I18n.t("minute")
            ? selMinute + I18n.t("minute") + ''
            : pad(selMinute),
        });
      }
    }
        ...
        ? [
            {
              ...
              props: {
                children: [
                  { value: '0', label: I18n.t("am") },
                  { value: '1', label: I18n.t("pm") },
                ],
              },
            },
          ]
